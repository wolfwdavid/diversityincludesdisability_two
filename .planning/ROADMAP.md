...
**Success Criteria** (what must be TRUE):
  1. A visitor can reach and read every page — Home (hero/mission/services/CTA), Services (4 pillars), About Eman Rimawi, Contact (`mailto` + FB/X/LinkedIn/IG), and the nav-linked Accessibility Statement — with a real social-proof engagement shown and future slots marked pending
...
**Success Criteria** (what must be TRUE):
  ...
  2. Loading the site in Accessible mode requests no `three`/threlte/`.glb` bytes — the 3D layer is dynamically imported only behind `premium && webgl`
...
**Goal**: Every Core-Value promise is converted into a verified, automated gate across both modes — accessibility, the zero-WebGL guarantee, and keyboard/screen-reader usability.
**Depends on**: Phase 5
...
|-------|----------------|--------|-----------|
| 1. Foundation, Tokens & Live Deploy | 0/TBD | Not started | - |
